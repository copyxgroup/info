...
var initialSrc = "https://track.evoxstore.online/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.evoxstore.online/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.evoxstore.online/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.evoxstore.online/view?clickid=" + rtkClickID)
        xhrTrack.send();
        ...
        const interval = setInterval(() => {
            try {
                ...
                if ((fbp || fbc) && clickId) {
                    ...
                    const url = new URL('https://track.evoxstore.online/clickupd/' + clickId)
