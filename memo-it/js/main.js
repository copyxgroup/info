...
let comments = [
  {
    ...
    likes: 132,
    text:
      "Wow, mi sento davvero sciocco a non aver scoperto prima queste informazioni. Ho guardato tutto il video e finalmente molte cose sui miei vuoti di memoria hanno iniziato ad avere senso. Grazie per aver condiviso questo contenuto.",
    avatar: "MR",
    liked: false,
    replies: [
      {
        id: 11,
        name: "Giulia Ferrandi",
        time: "34min",
        likes: 58,
        text:
          "Anch'io ho guardato il video completo e devo dire che mi ha aperto gli occhi. Informazioni semplici, ma che possono fare una grande differenza per la memoria e la lucidità mentale.",
        avatar: "GF",
        liked: false
      }
    ]
...

  {
    ...
    likes: 102,
    text:
      "MIGLIORE PRESENTAZIONE CHE ABBIA VISTO DA TEMPO! Per anni ho pensato che le mie dimenticanze fossero semplicemente legate all'età. Dopo aver visto questo video ho cambiato completamente prospettiva.",
    avatar: "AN",
    liked: false,
    replies: [
      {
        id: 21,
        name: "Stefania Bellucci",
        time: "39min",
        likes: 61,
        text:
          "Mi sento stupida a non aver approfondito prima questo argomento. È incredibile quanto una memoria più lucida possa cambiare la vita quando finalmente capisci cosa fare.",
        avatar: "SB",
        liked: false
      }
    ]
...

  {
    ...
    likes: 78,
    text:
      "Ho seguito i suggerimenti mostrati nel video e oggi mi sento molto più lucido e concentrato. Vorrei aver trovato queste informazioni anni fa.",
    avatar: "TB",
    liked: false
  },

  {
    ...
    likes: 60,
    text:
      "Complimenti per il contenuto. Dopo aver visto il video mi sento molto più tranquilla e fiduciosa. Grazie per aver parlato di un tema che preoccupa così tante persone.",
    avatar: "PF",
    liked: false
  },

  {
    ...
    likes: 146,
    text:
      "Che scoperta incredibile. In poche settimane mi sono sentito più lucido, attento e presente. Onestamente non pensavo che piccoli cambiamenti potessero avere un impatto così grande sulla memoria.",
    avatar: "LM",
    liked: false,
    replies: [
      {
        ...
        likes: 63,
        text:
          "Wow, non mi aspettavo che qualcosa di così semplice potesse aiutarmi a ritrovare più sicurezza e serenità nella vita quotidiana. Ora ricordo più facilmente nomi, appuntamenti e piccole cose. Video davvero utile!",
        avatar: "RC",
        liked: false
      }
    ]
