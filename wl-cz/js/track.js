...
var campaignID = "6a49d1a7cdbc7628e681952c";
...
var initialSrc = "https://wev.fitnesstodayx.site/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("wev.fitnesstodayx.site/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://wev.fitnesstodayx.site/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://wev.fitnesstodayx.site/view?clickid=" + rtkClickID)
        xhrTrack.send();
        ...
        const interval = setInterval(() => {
            try {
                ...
                if ((fbp || fbc) && clickId) {
                    ...
                    const url = new URL('https://wev.fitnesstodayx.site/clickupd/' + clickId)
